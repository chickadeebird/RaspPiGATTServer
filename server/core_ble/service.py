...
from server.core_ble.characteristic import Characteristic
from server.core_ble.constants import DBUS_PROP_IFACE, GATT_SERVICE_IFACE
from server.exceptions import InvalidArgsException
from server.util import check_flags
